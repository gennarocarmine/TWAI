...
Il confronto tra le due configurazioni evidenzia l'efficacia dell'ottimizzazione. A profondità $d=6$, il tempo di calcolo scende da \textbf{0.2858s} a \textbf{0.1328s}.\\\\
\noindent
Grazie a questo incremento di efficienza, abbiamo identificato in \textbf{$d=6$} la configurazione ideale per il sistema finale. Con un tempo di risposta ora ben al di sotto della soglia di percezione (0.13s), l'IA offre un'esperienza di gioco fluida e immediata ("Real-time"), pur mantenendo una profondità di analisi strategica elevata. Spingersi a $d=7$ rimane sconsigliato, in quanto porterebbe i tempi oltre il secondo, degradando la User Experience senza offrire un vantaggio tattico proporzionale contro un giocatore medio.
